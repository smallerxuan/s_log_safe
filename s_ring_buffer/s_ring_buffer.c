                              ...
                              s_ring_buffer_element_pool_destructor_t element_pool_destructor)
{
    ...
    s_ring_buffer_lock_destroy(&(s_ring_buffer_p->element_write_lock));
    s_ring_buffer_lock_destroy(&(s_ring_buffer_p->element_read_lock));
